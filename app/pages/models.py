...
class Activities(models.Model):
    ...
    date = models.DateTimeField(max_length=2000, db_column='date', verbose_name='Data')
    dedicated_time = models.TimeField(db_column='dedicated_time', verbose_name='Poświęcony czas')
